...
const TITLES: Record<string, string> = {
  ...
  '03-календари-и-нагрузка.md': 'Часть 3 · Календари, доступность и нагрузка',
  '04-посещаемость.md': 'Часть 4 · Посещаемость',
  '05-замены-и-переносы.md': 'Часть 5 · Замены и переносы',
  '06-зарплата-по-факту.md': 'Часть 6 · Зарплата по факту занятий',
}
